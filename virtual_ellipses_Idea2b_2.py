...
#TODO: rfp (radial frequency patterns) modulation for foveal
    Idea2:
        ...
        2b_2: add one or two extra disks in non-overlapping place. To distinguish area1 with area2, area3 with
        area 4, use rotation (pi/2).
"""
...
# 2b_2: add one extra disk, randomly in non-overlapping area: use rotation to 
# distinguish area1 with area2, area3 with area4
# =============================================================================
